...
s:option(Value, "max_chan_util_val", translate("Maximaum Channel Utilization Threshold"))
...
s = m:section(TypedSection, "metric", translate("IEE802.11", "Reasons for denying")); s.anonymous = true;
